...
mongoose.connect('mongodb://192.168.137.138:27017/myProducts', { useNewUrlParser: true, useUnifiedTopology: true });
...
app.post('/logs', upload.single('image'), async (req, res) => {
  ...
  res.send("Data Received...."); // Send the uploaded file details as response
});
